...
export default function SuppliersPage() {
  ...
  const handleCreate = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      await axiosInstance.post("/suppliers", { name, contact });
            ...
            <Dialog.Root open={open} onOpenChange={setOpen}>
              ...
              <Dialog.Portal>
                ...
                <Dialog.Content className="fixed top-1/2 left-1/2 w-full max-w-md -translate-x-1/2 -translate-y-1/2 bg-white p-6 rounded-xl shadow-lg space-y-6 animate-fadeIn">
                  <div className="flex justify-between items-center">
                    <Dialog.Title className="text-2xl font-bold text-gray-800">Add Supplier</Dialog.Title>
            ...
            <table className="min-w-full">
              <thead className="bg-gray-200">
                <tr>
                  ...
                  <th className="py-3 px-6 text-left text-sm font-semibold">Contact</th>
